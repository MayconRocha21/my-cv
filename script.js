  ...
  <body>
    <div class="container">
      <div class="information-column">
        ...
        <h2 class="areaAtual">Desenvolvedor Python | Análise de dados</h2>
        <hr/>
        ...
        <div class="experiences-column">
          ...
          <div>
            <p>
              Atuar como QA Jr, Desenvolvedor Python ou Análise de dados, aplicando minhas habilidades técnicas para contribuir com a qualidade dos projetos e crescer na área de tecnologia.
            </p>
          </div>
          </section>
